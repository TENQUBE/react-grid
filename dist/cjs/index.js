...
const cacheWidthValidation = (cacheData, columns) => {
    ...
    try {
        ...
        if (cacheWidths.some((width, i) => {
            return (columns[i].type === exports.GridType.Hidden && width !== null)
                || (columns[i].type !== exports.GridType.Hidden && width === null);
        }))
            return false;
        return cacheWidths;
    }
